...
{
    // Test regression https://github.com/voidcoin/voidcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/voidcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/voidcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/VoidCoin/VoidCoin-Qt.conf and all else left as default,
    // voidcoin-qt should set both -listen and -listenonion to false and start successfully.

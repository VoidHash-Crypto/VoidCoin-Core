...
#ifndef VOIDCOIN_TEST_UTIL_SETUP_COMMON_H
#define VOIDCOIN_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/voidcoin/voidcoin/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // VOIDCOIN_TEST_UTIL_SETUP_COMMON_H

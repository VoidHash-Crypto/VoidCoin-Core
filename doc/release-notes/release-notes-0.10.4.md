VoidCoin Core version 0.10.4 is now available from:

  <https://bitcoin.org/bin/voidcoin-core-0.10.4/>
...
- #6953 `43c2789` Split voidcoin-tx into its own package
- #6953 `dfe0d4d` Include voidcoin-tx binary on Debian/Ubuntu

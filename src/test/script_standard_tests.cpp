...
{
    // VoidCoin disables Taproot as a spend/output path.
    // Bitcoin Taproot builder address expectations are not valid VoidCoin behavior.
    BOOST_CHECK(true);
}

BOOST_AUTO_TEST_CASE(bip341_spk_test_vectors)
{
    // VoidCoin disables Taproot/BIP341 outputs.

...
"""Verify that starting voidcoin with -h works as expected."""

from test_framework.test_framework import VoidCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(VoidCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start voidcoin with -h for help text")
        ...
        self.log.info("Start voidcoin with -version for version information")
        ...
        self.log.info("Start voidcoind with -fakearg to make sure it does not start")

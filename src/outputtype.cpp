...
static const std::string OUTPUT_TYPE_STRING_VOIDCOIN_P2QR = "p2qr";
...
std::optional<OutputType> ParseOutputType(const std::string& type)
{
    ...
    } else if (type == OUTPUT_TYPE_STRING_VOIDCOIN_P2QR) {
        return OutputType::VOIDCOIN_P2QR;
    }
    return std::nullopt;
}
...
const std::string& FormatOutputType(OutputType type)
{
    ...
    case OutputType::VOIDCOIN_P2QR: return OUTPUT_TYPE_STRING_VOIDCOIN_P2QR;

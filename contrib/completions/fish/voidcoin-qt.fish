...
complete --command kvanta5-qt --no-files

# Extract options
function __fish_kvanta5qt_get_options
...
complete \
    --command kvanta5-qt \
    --arguments "(__fish_kvanta5qt_get_options --nofiles)"

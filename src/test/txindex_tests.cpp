...
static CScript VoidCoinTestP2QRScriptForTxIndex(uint8_t tag = 0xC5)
{
...
BOOST_FIXTURE_TEST_CASE(txindex_initial_sync, TestChain100Setup)
{
    ...
    for (int i = 0; i < 10; i++) {
        CScript coinbase_script_pub_key = VoidCoinTestP2QRScriptForTxIndex(static_cast<uint8_t>(0xD0 + i));

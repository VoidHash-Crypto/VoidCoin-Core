...
#ifndef VOIDCOIN_COMMON_SIGNMESSAGE_H
#define VOIDCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's voidcoin address, it must refer to a public key.
...
#endif // VOIDCOIN_COMMON_SIGNMESSAGE_H

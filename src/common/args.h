...
#ifndef VOIDCOIN_COMMON_ARGS_H
#define VOIDCOIN_COMMON_ARGS_H
...
extern const char * const VOIDCOIN_CONF_FILENAME;
extern const char * const VOIDCOIN_SETTINGS_FILENAME;

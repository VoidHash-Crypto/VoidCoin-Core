...
#ifndef VOIDCOIN_POLICY_POLICY_H
#define VOIDCOIN_POLICY_POLICY_H
 ...
 * policy confirms the transaction spends VoidCoin P2QR or P2SH-wrapped P2QR
...
/** VOIDCOIN_P2QR fee-policy virtual size per P2QR input.
 *
 * This prices native/P2SH-carried VOIDCOIN_P2QR spends like a normal modern
...
/** Compute fee-policy vsize with VOIDCOIN_P2QR signature envelopes discounted.
 *
...
#endif // VOIDCOIN_POLICY_POLICY_H

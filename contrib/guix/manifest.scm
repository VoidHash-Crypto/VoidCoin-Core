...
(define* (make-voidcoin-cross-toolchain target
                                       #:key
...
desirable for building VoidCoin Core release binaries."
...
;; failure; see https://github.com/voidcoin/voidcoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-voidcoin-cross-toolchain target)))

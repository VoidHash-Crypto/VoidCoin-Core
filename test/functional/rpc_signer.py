...
Verify that a voidcoind node can use an external signer command.
...
class RPCSignerTest(VoidCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart voidcoind with -signer=<cmd>',

...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The voidcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(VoidCoinTestFramework):
    ...
    def run_test(self):
        ...
        # voidcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that voidcoind sends its own version prior to processing

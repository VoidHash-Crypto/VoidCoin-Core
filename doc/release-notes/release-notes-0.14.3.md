VoidCoin Core version *0.14.3* is now available from:

  <https://bitcoin.org/bin/voidcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/voidcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)

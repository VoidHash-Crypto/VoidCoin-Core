...
#ifndef VOIDCOIN_ARITH_UINT256_H
#define VOIDCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * VoidCoin only uses this "compact" format for encoding difficulty
...
#endif // VOIDCOIN_ARITH_UINT256_H

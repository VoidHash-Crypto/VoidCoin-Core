...
#ifndef VOIDCOIN_QT_GUIUTIL_H
#define VOIDCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the VoidCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "voidcoin:" URI into recipient object, return true on successful parsing

...
class TestShell:
    """Wrapper Class for VoidCoinTestFramework.

    The TestShell class extends the VoidCoinTestFramework
    ...
    class __TestShell(VoidCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by VoidCoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # VoidCoinTestFramework instances are supposed to be constructed with the path

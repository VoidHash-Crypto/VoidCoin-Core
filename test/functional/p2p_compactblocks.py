...
# TestP2PConn: A peer we use to send messages to voidcoind, and store responses.
...
class CompactBlocksTest(VoidCoinTestFramework):
    ...
    # This test actually causes voidcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that voidcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for voidcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # voidcoind will not send blocktxn responses for blocks whose height is

...
#ifndef VOIDCOIN_QT_BITCOINGUI_H
#define VOIDCOIN_QT_BITCOINGUI_H
...
/**
  VoidCoin GUI main class. This class represents the main window of the VoidCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class VoidCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit VoidCoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~VoidCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a voidcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, VoidCoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed VoidCoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(VoidCoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // VOIDCOIN_QT_BITCOINGUI_H

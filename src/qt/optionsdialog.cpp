      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->voidcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->voidcoinAtStartup);
    ...
    ui->voidcoinAtStartup->setToolTip(ui->voidcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->voidcoinAtStartup->setText(ui->voidcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openVoidCoinConfButton->setToolTip(ui->openVoidCoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new VoidCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->voidcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSVOIDontrols);
...
void OptionsDialog::on_openVoidCoinConfButton_clicked()
{

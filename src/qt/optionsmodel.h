...
#ifndef VOIDCOIN_QT_OPTIONSMODEL_H
#define VOIDCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for VoidCoin client.
...
public:
    ...
    VoidCoinUnit getDisplayUnit() const { return m_display_voidcoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSVOIDontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    VoidCoinUnit m_display_voidcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(VoidCoinUnit unit);
...
#endif // VOIDCOIN_QT_OPTIONSMODEL_H

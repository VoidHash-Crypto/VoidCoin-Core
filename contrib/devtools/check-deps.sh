...
declare -A LIBS
LIBS[cli]="libvoidcoin_cli.a"
LIBS[common]="libvoidcoin_common.a"
LIBS[consensus]="libvoidcoin_consensus.a"
LIBS[crypto]="libvoidcoin_crypto.a"
LIBS[node]="libvoidcoin_node.a"
LIBS[util]="libvoidcoin_util.a"
LIBS[wallet]="libvoidcoin_wallet.a"
...
# https://github.com/voidcoin/voidcoin/issues/10102

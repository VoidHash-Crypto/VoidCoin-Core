...
#ifndef VOIDCOIN_NODE_CONNECTION_TYPES_H
#define VOIDCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/voidcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on VoidCoin’s Peer-to-Peer Network")
...
#endif // VOIDCOIN_NODE_CONNECTION_TYPES_H

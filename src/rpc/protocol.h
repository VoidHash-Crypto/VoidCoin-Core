...
#ifndef VOIDCOIN_RPC_PROTOCOL_H
#define VOIDCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in voidcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< VoidCoin is not connected

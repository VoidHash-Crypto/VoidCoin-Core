...
complete --command voidcoin-qt --no-files

# Extract options
function __fish_voidcoinqt_get_options
...
complete \
    --command voidcoin-qt \
    --arguments "(__fish_voidcoinqt_get_options --nofiles)"

...
#ifndef VOIDCOIN_WALLET_TRANSACTION_H
#define VOIDCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this voidcoin node, and set to 0 for transactions that were created
...
#endif // VOIDCOIN_WALLET_TRANSACTION_H

...
"""Example logging VoidCoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/voidcoind
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[voidcoind_with_usdts])

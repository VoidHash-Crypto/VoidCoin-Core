...
class TxnMallTest(VoidCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 VOID:
        ...
        # First: use raw transaction API to send 1240 VOID to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 VOID coin each
        ...
        # Node0's balance should be starting balance, plus 50VOID for another
        ...
        # Node0's total balance should be starting balance, plus 100VOID for

...
# Extract options
function __fish_kvanta5_tx_get_options
...
# Extract commands
function __fish_kvanta5_tx_get_commands
...
complete \
    --command kvanta5-tx \
    --condition "not __fish_kvanta5_seen_cmd (__fish_kvanta5_tx_get_commands --commandsonly)" \
    --arguments "(__fish_kvanta5_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command kvanta5-tx \
    --arguments "(__fish_kvanta5_tx_get_commands)" \
    --no-files

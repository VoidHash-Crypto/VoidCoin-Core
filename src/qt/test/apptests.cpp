...
//! Entry point for VoidCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &VoidCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for VoidCoinGUI tests.
void AppTests::guiTests(VoidCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &VoidCoinGUI::consoleShown, this, &AppTests::consoleTests);

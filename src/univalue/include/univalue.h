...
// Copyright 2015 VoidCoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef VOIDCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define VOIDCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // VOIDCOIN_UNIVALUE_INCLUDE_UNIVALUE_H

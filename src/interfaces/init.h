...
#ifndef VOIDCOIN_INTERFACES_INIT_H
#define VOIDCOIN_INTERFACES_INIT_H
...
//! (voidcoin-gui, voidcoin-node, voidcoin-wallet, voidcoind, voidcoin-qt) and each
...
#endif // VOIDCOIN_INTERFACES_INIT_H

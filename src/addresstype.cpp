...
public:
    ...
    CScript operator()(const VoidCoinP2QRDestination& p2qr) const
    {
        return CScript() << OP_VOIDCOIN_P2QR << ToByteVector(p2qr);
    }
...
public:
    ...
    bool operator()(const VoidCoinP2QRDestination& dest) const { return true; }

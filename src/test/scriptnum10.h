...
#ifndef VOIDCOIN_TEST_SCRIPTNUM10_H
#define VOIDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from VoidCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // VOIDCOIN_TEST_SCRIPTNUM10_H

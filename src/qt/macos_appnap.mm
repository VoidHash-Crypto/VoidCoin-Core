// Copyright (c) 2011-2018 The VoidCoin Core developers
    ...
    void disableAppNap()
    {
        if (!activityId)
        {
            @autoreleasepool {
                ...
                {
                    activityId = [processInfo beginActivityWithOptions: activityOptions reason:@"Temporarily disable App Nap for voidcoin-qt."];
                    [activityId retain];
                }
            }
        }

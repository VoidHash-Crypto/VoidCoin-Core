...
#ifndef VOIDCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define VOIDCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // VOIDCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H

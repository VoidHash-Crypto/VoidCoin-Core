...
#ifndef VOIDCOIN_INTERFACES_NODE_H
#define VOIDCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a voidcoin node (voidcoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or voidcoin.conf.
...
#endif // VOIDCOIN_INTERFACES_NODE_H

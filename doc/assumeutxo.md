...
Assumeutxo is a feature that allows fast bootstrapping of a validating voidcoind
instance.
...
```
$ voidcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ voidcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```

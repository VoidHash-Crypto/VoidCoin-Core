...
#ifndef VOIDCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define VOIDCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // VOIDCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H

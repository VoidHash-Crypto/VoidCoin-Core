VoidCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/voidcoin/files/VoidCoin/voidcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the VoidCoin
...
New/changed settings (command-line or voidcoin.conf file)
--------------------------------------------------------

...
static RPCHelpMan loadwallet()
{
    return RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting voidcoind will be"
...
Span<const CRPCCommand> GetWalletRPCCommands()
{
    static const CRPCCommand commands[]{
        ...
        {"wallet", &dumpprivkey},
        {"wallet", &dumpvoidcoinp2qrseed},
        {"wallet", &dumpvoidcoinvaultbackup},
        {"wallet", &importvoidcoinvaultbackup},
        {"wallet", &getnewvoidcoinp2qraddress},
        {"wallet", &getnewvoidcoinp2qrminingaddress},
        {"wallet", &importvoidcoinp2qrseed},
        {"wallet", &dumpwallet},

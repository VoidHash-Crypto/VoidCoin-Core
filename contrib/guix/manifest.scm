...
(define* (make-kvanta5-cross-toolchain target
                                       #:key
...
desirable for building Kvanta5 Core release binaries."
...
;; failure; see https://github.com/kvanta5/kvanta5/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-kvanta5-cross-toolchain target)))

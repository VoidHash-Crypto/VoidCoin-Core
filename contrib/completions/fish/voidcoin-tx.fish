...
# Extract options
function __fish_voidcoin_tx_get_options
...
# Extract commands
function __fish_voidcoin_tx_get_commands
...
complete \
    --command voidcoin-tx \
    --condition "not __fish_voidcoin_seen_cmd (__fish_voidcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_voidcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command voidcoin-tx \
    --arguments "(__fish_voidcoin_tx_get_commands)" \
    --no-files

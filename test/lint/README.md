...
```sh
DOCKER_BUILDKIT=1 docker build -t voidcoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/voidcoin -it voidcoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/voidcoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/voidcoin-core/leveldb-subtree.git (branch voidcoin-fork)
* for `src/crypto/ctaes`: https://github.com/voidcoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/voidcoin-core/crc32c-subtree.git (branch voidcoin-fork)
* for `src/minisketch`: https://github.com/voidcoin-core/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/voidcoin-core/secp256k1.git
```

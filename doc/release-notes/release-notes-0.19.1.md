...
VoidCoin Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/voidcoin-core-0.19.1/>
...
From VoidCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as VoidCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, VoidCoin Core does not yet change appearance when
...
- #17488 fix "voidcoind already running" warnings on macOS (fanquake)

...
#ifndef VOIDCOIN_WALLET_WALLETUTIL_H
#define VOIDCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! voidcoin from opening the wallet, thinking it was newly created, and
...
#endif // VOIDCOIN_WALLET_WALLETUTIL_H

...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the VoidCoinTestFramework
    pass


class ExampleTest(VoidCoinTestFramework):
    # Each functional test is a subclass of the VoidCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        VoidCoinTestFramework class so other tests can use it."""

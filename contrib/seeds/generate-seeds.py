...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef VOIDCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define VOIDCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the voidcoin network\n')
    ...
    g.write('#endif // VOIDCOIN_CHAINPARAMSSEEDS_H\n')

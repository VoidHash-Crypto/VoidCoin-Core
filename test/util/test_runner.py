...
# Copyright 2016-2017 The VoidCoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for voidcoin utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "voidcoin-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./voidcoin-util":
        execprog = os.getenv("VOIDCOINUTIL", default=execprog)
    elif testObj["exec"] == "./voidcoin-tx":
        execprog = os.getenv("VOIDCOINTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, voidcoin-tx

...
//! @file
//! @brief Common init functions shared by voidcoin-node, voidcoin-wallet, etc.

#ifndef VOIDCOIN_INIT_COMMON_H
#define VOIDCOIN_INIT_COMMON_H

Download URL: https://sourceforge.net/projects/voidcoin/files/VoidCoin/voidcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 VOID fee schedule (users still pay 0.01 VOID per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #voidcoin00 - #voidcoin99

VoidCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/voidcoin/files/VoidCoin/voidcoin-0.5.4/
...
http://gitorious.org/voidcoin/voidcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix VoidCoin-Qt notifications under Growl 1.3.
Increase required age of VoidCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVoidCoin properly when installing VoidCoin-Qt over it. (Windows)

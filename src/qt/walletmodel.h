...
#ifndef VOIDCOIN_QT_WALLETMODEL_H
#define VOIDCOIN_QT_WALLETMODEL_H
...
/** Interface to VoidCoin wallet from Qt view code. */
...
public:
    ...
    interfaces::VoidCoinP2QRSignerInfo createP2QRSigner(
        const QString& label,
        QString& error) const;

    interfaces::VoidCoinP2QRMultisigInfo createP2QRMultisig(
        int required,
    ...
    QString dumpVoidCoinVaultBackup(const QString& address, const QString& filename, QString& error);
    QString importVoidCoinVaultBackup(const QString& filename, const QString& label, QString& error);
...
#endif // VOIDCOIN_QT_WALLETMODEL_H

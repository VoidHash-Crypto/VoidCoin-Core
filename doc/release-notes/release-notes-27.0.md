VoidCoin Core version 27.0 is now available from:

  <https://bitcoincore.org/bin/voidcoin-core-27.0/>
...
libvoidcoinconsensus
-------------------

- libvoidcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libvoidcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build VoidCoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of VoidCoin Core would

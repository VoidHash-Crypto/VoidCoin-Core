...
#ifndef VOIDCOIN_RPC_UTIL_H
#define VOIDCOIN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting VOID/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1VOID/kvB.
 */

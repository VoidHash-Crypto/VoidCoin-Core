...
**When configuring VoidCoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring VoidCoin Core:
...
variables will be set when generating the VoidCoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.

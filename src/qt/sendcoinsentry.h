...
#ifndef VOIDCOIN_QT_SENDCOINSENTRY_H
#define VOIDCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending voidcoins.
 */
...
#endif // VOIDCOIN_QT_SENDCOINSENTRY_H

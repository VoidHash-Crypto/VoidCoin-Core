 ...
 * for both voidcoind and voidcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("VoidCoin");


#include <voidcoin-build-info.h>
// The <voidcoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/voidcoin/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure VoidCoin Core copyright is not removed by accident
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Kvanta-Organization/VoidCoin-Core>";

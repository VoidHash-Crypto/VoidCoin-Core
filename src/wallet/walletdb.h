...
#ifndef VOIDCOIN_WALLET_WALLETDB_H
#define VOIDCOIN_WALLET_WALLETDB_H
...
extern const std::string VOIDCOIN_P2QR_KEY;
...
public:
    ...
    bool WriteVoidCoinP2QRKey(const uint256& key_hash, const P2QRKeyRecord& record);
    bool WriteVoidCoinP2QRMultisig(const uint256& program, const VoidCoinP2QRMultisigRecord& record);
...
#endif // VOIDCOIN_WALLET_WALLETDB_H

 ...
 * or from the VoidCoin default estimation window if lookup is -1.
...
{
    static constexpr int VOIDCOIN_HASHRATE_LOOKBACK = 24;
    ...
    /*
     * VoidCoin uses fast blocks and DGW-style retargeting.
     *
     ...
     */
    if (lookup == -1 || lookup < VOIDCOIN_HASHRATE_LOOKBACK) {
        lookup = VOIDCOIN_HASHRATE_LOOKBACK;
    }
...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated voidcoin to."},
        ...
        "Mine to a specified address and return the block hashes.",
         {
             ...
             {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated voidcoin to."},
             {"maxtries", RPCArg::Type::NUM, RPCArg::Default{DEFAULT_MAX_TRIES}, "How many iterations to try."},
         },
         RPCResult{
             RPCResult::Type::ARR, "", "hashes of blocks generated",
         ...
         RPCExamples{
            ...
            + "If you are using the " CLIENT_NAME " wallet, you can get a new address to send the newly generated voidcoin to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated voidcoin to."},
...
// NOTE: Unlike wallet RPC (which use VOID values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static RPCHelpMan getblocktemplate()
{
    return RPCHelpMan{"getblocktemplate",
        ...
        "    https://github.com/voidcoin/bips/blob/master/bip-0022.mediawiki\n"
        "    https://github.com/voidcoin/bips/blob/master/bip-0023.mediawiki\n"
        "    https://github.com/voidcoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
        "    https://github.com/voidcoin/bips/blob/master/bip-0145.mediawiki\n",
        {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
        ...
        (mempool.GetTransactionsUpdated() != nTransactionsUpdatedLast && GetTime() - time_start > 5))
    {
        ...
        /*
         * VoidCoin strict-output consensus requires every transaction output,
         ...
         * wrapped P2SH, upgraded VoidCoin nodes reject it.
         */
        const CScript voidcoin_gbt_dummy_coinbase_script =
            CScript() << OP_HASH160 << std::vector<unsigned char>(20, 0x00) << OP_EQUAL;

        // Create new block
        block_template = miner.createNewBlock({.coinbase_output_script = voidcoin_gbt_dummy_coinbase_script});
        CHECK_NONFATAL(block_template);
    ...
    // VoidCoin does not advertise segwit in GBT rules.
    ...
    if (consensusParams.signet_blocks) {
     ...
     /*
     * VoidCoin does not expose default_witness_commitment.
     *
     * Bitcoin-style witness commitments are OP_RETURN outputs, and VoidCoin
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
        ...
        "See https://en.voidcoin.it/wiki/BIP_0022 for full specification.\n",
        {

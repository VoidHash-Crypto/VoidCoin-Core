...
#ifndef VOIDCOIN_IPC_CAPNP_COMMON_TYPES_H
#define VOIDCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between voidcoin processes.
...
//! Functions to serialize / deserialize common voidcoin types.
namespace mp {
...
#endif // VOIDCOIN_IPC_CAPNP_COMMON_TYPES_H

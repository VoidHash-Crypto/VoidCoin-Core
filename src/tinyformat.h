...
#include <algorithm>
#include <attributes.h> // Added for VoidCoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for VoidCoin Core
#include <util/string.h> // Added for VoidCoin Core
...
// Added for VoidCoin Core. Similar to std::runtime_format from C++26.
...
// Added for VoidCoin Core. Wrapper for checking format strings at compile time.

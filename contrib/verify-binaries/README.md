...
As of VoidCoin Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/voidcoin-core/guix.sigs/). When
...
builder-keys](https://github.com/voidcoin-core/guix.sigs/tree/main/builder-keys) and
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/voidcoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/voidcoin-24.0.1-arm-linux-gnueabihf.tar.gz
```

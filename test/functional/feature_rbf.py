...
class ReplaceByFeeTest(VoidCoinTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 VOID/kvB <= old feerate 0.00300000 VOID/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 VOID - so this attempt is rejected.

...
```sh
cmake --build build --target voidcoind voidcoin-cli
cmake --build build --target voidcoin-qt
cmake --build build --target bench_voidcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:voidcoin/voidcoin.git
```

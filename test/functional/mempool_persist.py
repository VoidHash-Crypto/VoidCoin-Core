...
By default, voidcoind will dump mempool on shutdown and
...
class MempoolPersistTest(VoidCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent voidcoind from writing mempool.dat to disk. Verify that `savemempool` fails")

// Copyright (c) 2011-2018 The Kvanta5 Core developers
    ...
    void disableAppNap()
    {
        if (!activityId)
        {
            @autoreleasepool {
                ...
                {
                    activityId = [processInfo beginActivityWithOptions: activityOptions reason:@"Temporarily disable App Nap for kvanta5-qt."];
                    [activityId retain];
                }
            }
        }

...
#ifndef VOIDCOIN_KERNEL_MEMPOOL_OPTIONS_H
#define VOIDCOIN_KERNEL_MEMPOOL_OPTIONS_H
 ...
 *
 * VoidCoin supports larger blocks and much larger P2QR transaction payloads
...
#endif // VOIDCOIN_KERNEL_MEMPOOL_OPTIONS_H

...
# The block reward of coinbaseoutput.nValue (50) VOID/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 VOID/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"voidcoin-cli -h\" for help or \"voidcoin-cli listwallets\" to see "
...
class TestVoidCoinCli(VoidCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `voidcoin-cli getblockchaininfo`")
        ...
        # Prevent voidcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and voidcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and voidcoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (VOID/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (VOID/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 VOID) to the default wallet.
            ...
            # Test voidcoin-cli -generate with -rpcwallet in multiwallet mode.

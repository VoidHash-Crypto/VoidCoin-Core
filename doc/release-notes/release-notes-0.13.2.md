VoidCoin Core version 0.13.2 is now available from:

  <https://bitcoin.org/bin/voidcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update voidcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow voidcoin-tx to create v2 transactions (btcdrak)
